      ...
      <AnimatePresence initial={false}>
        {isOpen && (
          ...
          >
            ...
            >
              <FieldArray name="flowSteps">
                {({ push, remove, form }) => (
                  <motion.div layout className="space-y-6">
                    <AnimatePresence>
                      {form.values.flowSteps.map(
                        (_: any, index: number) => (
                          <motion.div
                            key={index}
                            layout
                          ...
                          >
                            <button
                              ...
                              disabled={
                                form.values.flowSteps.length === 1
                              }
                              className="absolute right-4 top-4 text-red-500 transition hover:text-red-700 disabled:opacity-30"
                            >
                              <Trash2 size={18} />
                            </button>
                            ...
                            <div className="space-y-4">
                              <div className="space-y-2">
                                ...
                                <Field
                                  name={`flowSteps.${index}.title`}
                                  placeholder="Capital Call"
                              ...
                              <div className="space-y-2">
                                ...
                                <Field
                                  as="textarea"
                                  rows={4}
                                  name={`flowSteps.${index}.description`}
