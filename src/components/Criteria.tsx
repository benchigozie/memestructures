                            ...
                            <div className="space-y-4">
                              <div className="space-y-2">
                                ...
                                <Field
                                  ...
                                  placeholder="High Conviction Businesses"
                              ...
                              <div className="space-y-2">
                                ...
                                <Field
                                  ...
                                  placeholder="Describe this investment criterion..."
                                  className="w-full rounded-lg p-3 outline outline-my-gray/20 transition-colors duration-300 focus:outline-my-deep-blue/40"
                                />
                              </div>
                              ...
                              <div className="space-y-2">
                                ...
                                <Field
                                  as="textarea"
                                  rows={3}
                                  name={`criteria.${index}.signal`}
                                  placeholder="Optional investment signal..."
                                  className="w-full rounded-lg p-3 outline outline-my-gray/20 transition-colors duration-300 focus:outline-my-deep-blue/40"
                                />
                              </div>
                            </div>
