                    ...
                    <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                        ...
                        >
                            <div className="flex justify-between">
                                <h3 className="text-my-deep-blue text-xl md:text-2xl">Diversified Income Memecoin Fund</h3>
                        ...
                        >
                            <div className="flex justify-between">
                                <h3 className="text-my-deep-blue text-xl md:text-2xl">Dividend and Income Altcoin Fund</h3>
                        ...
                        >
                            <div className="flex justify-between">
                                <h3 className="text-my-deep-blue text-xl md:text-2xl">Extended Duration Memecoin Fund</h3>
                                <div className="py-1 px-2 bg-red-100 rounded-md flex items-center h-max">
                                    <p className="text-xs text-red-600">AGGRESSIVE</p>
                                </div>
                            </div>
                        ...
                        >
                            <div className="flex justify-between">
                                <h3 className="text-my-deep-blue text-xl md:text-2xl">Emerging Market and Short-term Memecoin Fund</h3>
                                <div className="py-1 px-2 bg-green-100 rounded-md flex items-center h-max">
                                    <p className="text-xs text-green-600">BALANCED</p>
                                </div>
                            </div>
